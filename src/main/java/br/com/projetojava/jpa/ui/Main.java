package br.com.projetojava.jpa.ui;

import java.util.List;
import java.util.Scanner;

import br.com.projetojava.jpa.models.Pessoa;
import br.com.projetojava.jpa.services.impl.PessoaService;
import br.com.projetojava.jpa.services.interfaces.CrudService;
import br.com.projetojava.jpa.services.interfaces.PessoaBuscaPorNome;
...
public class Main {
	...
	private static void atualizarPessoa() {
		...
		if (pessoaAtual != null) {
			...
			System.out.println("Não existe pessoas com esse ID.");
		}
	}
